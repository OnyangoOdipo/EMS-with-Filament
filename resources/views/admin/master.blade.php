    ...
    <footer class="bg-dark flex-grow-0  text-center text-white w-100">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <!-- Twitter -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/Sh_odipo" role="button"><i
                        class="fa-brand fa-x-twitter"></i></a>

                <!-- Instagram -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/_soltaire/"
                    role="button"><i class="fab fa-instagram"></i></a>

                <!-- Linkedin -->
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/shadrack-onyango/"
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)" ;>
            ...
            <a class="text-white" href="https://github.com/">EMS</a>
        </div>
    </footer>
