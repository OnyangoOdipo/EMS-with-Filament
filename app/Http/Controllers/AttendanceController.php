...
class AttendanceController extends Controller
{
    ...
    public function checkIn()
    {
        ...
        Attendance::create([
            ...
            'check_out' => null,
            'overtime' => null,
            'duration_minutes' => null, // Set this initially to null or calculate it when checkout happens
        ]);        
    ...
    {
        $existingAttendance = Attendance::where('employee_id', auth()->user()->employee->id)
            ->whereDate('select_date', now()->toDateString())
            ->first();
